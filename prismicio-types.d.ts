...
export interface BentoSliceDefaultItem {
  ...
  /**
   * SubTilte field in *Bento → Items*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.items[].subtilte
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  subtilte: prismic.RichTextField;
...
export interface HeroBannerSliceDefaultPrimary {
  ...
  /**
   * Body field in *HeroBanner → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_banner.primary.body
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  body: prismic.RichTextField;
...
export interface IntegrationsSliceDefaultItem {
   ...
   */
  icon: prismic.SelectField<"npm" | "github" | "figma" | "aws">;
}
