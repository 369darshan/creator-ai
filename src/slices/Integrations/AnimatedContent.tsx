...
import { FaNpm, FaGithub, FaFigma, FaAws } from "react-icons/fa6";
        ...
        <div className="mt-20 flex flex-col items-center md:flex-row" ref={container}>
            {
                slice.items.map((item, index) => (
                    <React.Fragment key={index}>
                        ...
                        <div className="pulsing-icon flex aspect-square shrink-0 items-center justify-center rounded-full border border-blue-50/30 bg-blue-50/25 text-3xl text-blue-100 opacity-40 md:text-4xl lg:text-5xl">
